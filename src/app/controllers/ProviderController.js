...
class ProviderController {
  async index(req, res) {
    try {
      ...
      return res.json({ error: 'Houve um erro ao listar providers' });
    }
  }
  ...
  async store(req, res) {
    try {
      ...
      return res.json({ error: 'Houve um erro ao cadastar um provider' });
    }
  }
  ...
  async cadastro(req, res) {
    try {
      ...
      return res.json({ error: 'Houve um erro ao atualizar o cadastro de provider' });
    }
  }
  ...
  async update(req, res) {
    try {
      ...
      return res.json({ error: 'Houve um erro ao atualizar um provider' });
    }
  }
}
